...
`git remote add upstream git@github.com:aproint/copilot-cli`
...
* Add the package your interface is in under the [gen-mocks](https://github.com/aproint/copilot-cli/blob/master/Makefile) command in the Makefile.
* run `make gen-mocks`
...
You can also check out our [issues queue](https://github.com/aproint/copilot-cli/issues) to see all the known issues - this is a really great place to start.

If you want to get your feet wet, check out issues tagged with [good first issue](https://github.com/aproint/copilot-cli/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22).
