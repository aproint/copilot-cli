...
To view examples and an explanation of how YAML patches work, check out the [documentation](https://aproint.github.io/copilot-cli/docs/developing/overrides/yamlpatch).
