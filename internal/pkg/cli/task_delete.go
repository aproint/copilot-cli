...
func newDeleteTaskOpts(ctx context.Context, vars deleteTaskVars) (*deleteTaskOpts, error) {
...
// Validate validates task deletion flags using ctx for remote lookups.
func (o *deleteTaskOpts) Validate(ctx context.Context) error {
...
func (o *deleteTaskOpts) askTaskName(ctx context.Context) error {
	...
	if o.defaultCluster {
		task, err := sel.Task(ctx, taskDeleteNamePrompt, "", selector.TaskWithDefaultCluster())
		if err != nil {
	...
	task, err := sel.Task(ctx, taskDeleteNamePrompt, "", selector.TaskWithAppEnv(o.app, o.env))
	if err != nil {
...
func (o *deleteTaskOpts) stopTasks(ctx context.Context) error {
	...
	// Stop tasks.
	if o.defaultCluster {
		if err = o.newTaskStopper(cfg).StopDefaultClusterTasks(ctx, o.name); err != nil {
		...
		if err = o.newTaskStopper(cfg).StopOneOffTasks(ctx, o.app, o.env, o.name); err != nil {
...
func (o *deleteTaskOpts) clearECRRepository(ctx context.Context) error {
	...
	err = o.newImageRemover(defaultConfig).ClearRepository(ctx, ecrRepoName)
	if err != nil {
...
func (o *deleteTaskOpts) emptyS3Bucket(ctx context.Context, info *deploy.TaskStackInfo) error {
	...
	err = o.newBucketEmptier(cfg).EmptyBucket(ctx, info.BucketName)
	if err != nil {
...
func (o *deleteTaskOpts) getTaskInfo(ctx context.Context) (*deploy.TaskStackInfo, error) {
	...
	info, err := o.newStackManager(cfg).GetTaskStack(ctx, o.name)
...
func (o *deleteTaskOpts) deleteStack(ctx context.Context) error {
	...
	err = o.newStackManager(cfg).DeleteTask(ctx, *info)
	if err != nil {
...
func BuildTaskDeleteCmd() *cobra.Command {
  ...
  /code $ copilot task delete --name test --yes`,
		RunE: runCmdE(func(cmd *cobra.Command, args []string) error {
			opts, err := newDeleteTaskOpts(cmd.Context(), vars)
			if err != nil {
				return err
			}
